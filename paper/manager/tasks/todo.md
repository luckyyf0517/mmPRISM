...
| `DATA-003` | 为各数据族生成只读 source manifest | `DATA-002` | in_progress | CSL-News partial contract/linkage 已验证；`001/005/008` 隔离且 promotion gate 已修复；待 replacement 和 436-archive complete manifest |
