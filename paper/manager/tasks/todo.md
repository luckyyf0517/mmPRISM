...
| `DATA-003` | 为各数据族生成只读 source manifest | `DATA-002` | in_progress | CSL-News v2 registry 为 71 archive/118,075 videos passed，`001/005/008` replacement 已验收；12,057-record clean pose snapshot 已含恢复样本，待 436-archive complete manifest |
