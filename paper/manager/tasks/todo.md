...
| `DATA-003` | 为各数据族生成只读 source manifest | `DATA-002` | in_progress | CSL-News partial manifest contract/linkage 已验证，但 `005/008` CRC 失败；待 replacement、436-archive complete manifest 和其他数据族验证 |
