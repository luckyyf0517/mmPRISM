...
| `DATA-001-K` | P0 | 下载并验证 CSL-News 官方 RGB/labels | in_progress | versioned replacement `001/005/008` 已通过完整 gate；v2 registry 当前 62 archives/102,949 videos passed，待其余 374 archives + labels 全量验证 |
