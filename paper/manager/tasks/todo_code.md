...
| `ARCH-006-A` | P2 | 统一 prediction/result artifact schema | in_progress | OmniHand/WaveLLM single-rank JSONL、Safetensors 和原子 register 已通过；待 distributed-safe writer/aggregator |
