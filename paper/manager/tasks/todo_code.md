...
| `ARCH-002-D` | P1 | 建立统一 CLI 和 dry-run | in_progress | doctor/config/manifest/plan、CSL-News audit/annotate/status/QC/metadata profile 已落地；train/eval/prepare 待实现 |
