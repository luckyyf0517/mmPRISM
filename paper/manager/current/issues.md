...
| `EXP-TEST-001` | P1 | legacy 无自动化测试；canonical 已覆盖 foundation、radar、OmniHand/WaveLLM 工程切片、两条 clean-commit GPU formal 闭环和 distributed-safe prediction artifact contract | 真实数据、恢复训练、DDP model execution 和 checkpoint aggregation 仍缺保护 | in_progress | 扩展真实 manifest、resume、DDP/checkpoint integration tests |
