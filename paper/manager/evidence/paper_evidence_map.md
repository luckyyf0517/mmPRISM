...
| `EVID-REV-DATASET` | Methods: Datasets and synthetic data generation | dataset characterization and split transparency | `ED-SCI-4`,`R1-4b`,`R2-4` | pending | `DATA-REV-001` | descriptive/split audit | pending | blocked | not_started |
