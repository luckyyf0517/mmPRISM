...
if __name__ == '__main__':
    ...
    depth_anything.load_state_dict(torch.load(f'demo/depth_anything_v2/checkpoints/depth_anything_v2_{args.encoder}.pth', map_location='cpu'))
    ...
    for k, filename in enumerate(filenames):
        ...
        while raw_video.isOpened():
            ...
            if not ret:
                break
            raw_frame = raw_frame[15:-35, 22:-22]
