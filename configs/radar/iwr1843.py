...
num_chirps = 64
frame_period = 2e-2
chirp_period = (idle_time + ramp_end_time) * num_chirps * 3
assert chirp_period <= frame_period, f"Duty circle exceeds frame period: {chirp_period} >= {frame_period}"
