...
conv_llama_V3_1_instruct = Conversation(
    system="<|begin_of_text|><|start_header_id|>system<|end_header_id|>A chat between a curious user and an artificial intelligence assistant. Based on a 3D scene or a 3D model, the assistant gives helpful, detailed, and polite answers to the user's questions.<|eot_id|>",
...
default_conversation = conv_llama_V3_1_instruct
conv_templates = {
    "default": conv_v1_2,
    "simple": simple_conv,
    ...
    "llama3": conv_llama_V3_1_instruct,
    "qwen": conv_qwen,
    "conv_phi3": conv_phi3
}
...
def create_dummy_data(batch_size=2, num_patches=10, hidden_dim=768):
    ...
    # 在start和end标记之间添加num_patches个空格，为特征预留位置
    placeholder = ' ' * num_patches
