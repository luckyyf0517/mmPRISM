...
|---|---|---|---|
| Original submitted manuscript | [original submission intake](../40_OPERATIONS/ORIGINAL_SUBMISSION.md) | not_started | 导入 PDF/TeX 和提交日期 |
| Decision letter | [decision letter](../../logs/2026/08/20260811_DECISION_LETTER.md) | done | 已提取决定和 mandatory requirements |
| Reviewer comments EN | [review EN](../../logs/2026/08/20260811_REVIEW_EN.md) | done | 已按 R1/R2/R2-CODE 编号并保留原文 |
| Reviewer comments CN | [review CN](../../logs/2026/08/20260811_REVIEW_CN.md) | done | 已完成中文工作版 |
...
1. `Data Availability` 和 `Code Availability` 目前只出现在注释模板中，正式章节缺失；处置和
   closure gate 见 [availability](../20_CONTRACTS/AVAILABILITY.md)。
2. 有效正文有 30 个语言审计命中：12 个编辑明确列举词、18 个证据敏感强表述；逐项位置和
   处理规则见 [editorial language](EDITORIAL_LANGUAGE.md)。
